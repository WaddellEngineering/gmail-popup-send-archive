...
The icons were generated during project creation and should already be in the `icons/` folder. If they are missing, open `generate-icons.html` in any browser — the three PNG files will be downloaded automatically. Place them in `icons/`:
